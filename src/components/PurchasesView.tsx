  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4">
      <motion.div
        ...
        className="bg-white rounded-3xl max-w-2xl w-full max-h-[90vh] flex flex-col shadow-2xl overflow-hidden border border-slate-100"
      >
        {/* Header */}
          ...
          <form onSubmit={handleUpload} className="space-y-3">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Button
                ...
                className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 px-5 text-xs rounded-xl shrink-0"
              >
